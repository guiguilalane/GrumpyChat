	...
	public void actionPerformed(ActionEvent event) {
		if (event.getSource().equals(this.clearButton)) {
			...
			try {
				...
				ServerRemoteForum server = new ServerRemoteForum(this.cd
						.getClient().getPort()+1, subject, this.cd.getServer()
						.getClients());
				DiscussionSubjectInterface dsi = server
						.create(this.cd, subject);
				if (dsi != null) {
