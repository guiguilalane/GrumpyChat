...
public interface ServerForumInterface extends Remote {
	...
	/**
	 * Returns the DiscussionSubject identified by a string title,
	 * <code>null</code> otherwise
	 * 
	 * @param title
	 *            {@link String} - The discussion title
	 * @return {@link DiscussionSubjectInterface} - The discussion,
	 ...
	 * Same as toString
	 * 
	 * @see {@link ServerForum#toString()}
	 */
	public String display() throws RemoteException;

	/**
	 * <code>true</code> if the pseudo in parameters is already used in the
	 * {@link server.objects.ServerForum#getDiscussions() connected users list}
	 * 
	 * @param pseudo
	 *            {@link String} - The pseudonyme
	 * @return {@link Boolean boolean} - <code>true</code> if this pseudo is
	 *         already used, <code>false</code> otherwise
	 * @throws RemoteException
	 */
	public boolean containsPseudo(String pseudo) throws RemoteException;

	/**
	 * Send a request on the {@link DiscussionSubjectInterface discussion
	 * subject} to add this user in its list
	 * 
	 * @param dsi
	 *            {@link DiscussionSubjectInterface} - The discussion subject
	 * @param client
	 *            {@link ClientDisplayerInterface} - The client to subscribe
	...
	/**
	 * Send a request on the {@link DiscussionSubjectInterface discussion
	 * subject} to remove this user in its list
	 * 
	 * @param dsi
	 *            {@link DiscussionSubjectInterface} - The discussion subject
	 * @param client
	...
	/**
	 * Create an user in the {@link server.objects.ServerForum#clients connected
	 * users list}
	 * 
	 * @param client
	 *            {@link ClientDisplayerInterface} - The client to add
	...
	/**
	 * Return the {@link ClientDisplayerInterface client controller} of a
	 * specific {@link ClientInterface client}
	 * 
	 * @param ci
	 *            {@link ClientInterface} - The client to find
	...
	/**
	 * Remove an user from the {@link server.objects.ServerForum#clients
	...
	/**
	 * Send a message to all {@link server.objects.ServerForum#clients connected
	 * users}, from a specific user who does not receive the message. It can be
	 * send by the forum server for all users with its
	 * {@link server.objects.ServerForum#client client instance}
	 * 
	 * @param client
	 *            {@link ClientDisplayerInterface} - The client who send the
	 *            message
	 * @param message
	 *            {@link String} - The message to send
	 * @return {@link Boolean boolean} - <code>true</code> if the message has
	 *         been correctly sent to others users, <code>false</code> otherwise
	 * @throws RemoteException
	 */
	 ...
	 * 
	 * @param client
	 *            {@link ClientDisplayerInterface} - The discussion subject
	 *            author
	 * @param subject
	 *            {@link String} - The channel name
	 * @return {@link DiscussionSubjectInterface} - The discussion subject if it
	 *         has been created, <code>null</code> otherwise
	 * @throws RemoteException
	 */
	 ...
	 * by the specific {@link ClientDisplayerInterface user}
	 * 
	 * @param client
	 *            {@link DiscussionSubjectInterface} - The client displayer
	...
	/**
	 * Returns <code>true</code> if the specific
	 * {@link ClientDisplayerInterface user} has the maximum number of created
	 * {@link DiscussionSubjectInterface channel}
	 * 
	 * @param client
	 *            {@link DiscussionSubjectInterface} - The client displayer
	 * @return {@link Boolean boolean} - <code>true</code> if the client has
	 *         already created the maximum of allowed channels,
	 ...
	 *            {@link String} - The channel name
	 * @return {@link DiscussionSubjectInterface} - The discussion subject if it
	 *         has been removed, <code>null</code> otherwise
	 * @throws RemoteException
	 */
	...
	/**
	 * Returns <code>true</code> if the specific
	 * {@link ClientDisplayerInterface user} is the author of a specific
	 * {@link DiscussionSubjectInterface channel}
	 * 
	 * @param client
	 *            {@link DiscussionSubjectInterface} - The client displayer
	 ...
	 * 
	 * @param client
	 *            {@link ClientDisplayerInterface} - The client controller
	 *            source
	 * @param discussion
	 *            {@link DiscussionSubjectInterface} - The discussion to add the
	 *            message
	 * @param msg
	 *            {@link MessageInterface} - The message to add
	 * @return {@link Boolean boolean} - <code>true</code> if the message has
	 *         been correctly added in the discussion, <code>false</code>
	 *         otherwise
	 * @throws RemoteException
	 */
	 ...
	 * 
	 * @param client
	 *            {@link ClientDisplayerInterface} - The controller source
	 * @throws RemoteException
	 */
	...
	/**
	 * Close all discussion frames for users that have it open for a specific
	 * discussion
	 * 
	 * @param client
	 *            {@link ClientDisplayerInterface} - The client controller
	 ...
	 * @return {@link String} - The discussion owner's pseudo, the server client
	 *         name otherwise
	 * @throws RemoteException
	 */
	public String getOwner(DiscussionSubjectInterface discussion)
			throws RemoteException;
	...
	/**
	 * Try to set the new discussion owner from a client
	 * 
	 * @param discussion
	 *            {@link DiscussionSubjectInterface} - The discussion to set new
	 *            owner
	 * @param client
	 *            {@link ClientDisplayerInterface} - The client who wants to be
	 *            new owner
	 * @return {@link Boolean boolean} - <code>true</code> if the client is now
	 *         the discussion owner, <code>false</code> otherwise
	 * @throws RemoteException
	 */
