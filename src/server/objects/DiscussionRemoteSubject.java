...
public class DiscussionRemoteSubject extends UnicastRemoteObject implements
	...
	public DiscussionRemoteSubject(String title, ClientDisplayerInterface owner,
			String url)
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DiscussionRemoteSubject other = (DiscussionRemoteSubject) obj;
	...
	public String toString() {
		synchronized (this.clients) {
			return "DiscussionRemoteSubject [title=" + this.title + ", clients: "
